...
CREATE TABLE "DocumentChecklist" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "requestId" TEXT NOT NULL,
    "formFilled" TEXT NOT NULL DEFAULT 'PENDENTE',
    "supplierIdentified" TEXT NOT NULL DEFAULT 'PENDENTE',
    "anvisa" TEXT NOT NULL DEFAULT 'PENDENTE',
    "preventiveMaintenance" TEXT NOT NULL DEFAULT 'PENDENTE',
    "calibration" TEXT NOT NULL DEFAULT 'PENDENTE',
    "tse" TEXT NOT NULL DEFAULT 'PENDENTE',
    "manual" TEXT NOT NULL DEFAULT 'PENDENTE',
    "signedTerm" TEXT NOT NULL DEFAULT 'PENDENTE',
    "accessories" TEXT NOT NULL DEFAULT 'PENDENTE',
    "sanitization" TEXT NOT NULL DEFAULT 'PENDENTE',
    "insurance" TEXT NOT NULL DEFAULT 'PENDENTE',
...
CREATE TABLE "TechnicalInspection" (
    ...
    "alarms" BOOLEAN,
    "electricalCompatibility" BOOLEAN,
    "gasCompatibility" BOOLEAN,
    "infrastructureCompat" BOOLEAN,
    "metrologicalEval" BOOLEAN,
