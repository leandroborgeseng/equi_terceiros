...
CREATE TABLE "new_EquipmentRequest" (
    ...
    "accessInviteId" TEXT,
    "originatedByEc" BOOLEAN NOT NULL DEFAULT false,
    "alreadyInPark" BOOLEAN NOT NULL DEFAULT false,
    "invoiceId" TEXT,
    ...
    CONSTRAINT "EquipmentRequest_invoiceId_fkey" FOREIGN KEY ("invoiceId") REFERENCES "Invoice" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
